...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="XWt3lSBctCtQhRBX7ZjbRROn2XC8bjomUEJEsRMM6pwqTslmoZk9OHIYZ3SWJ4NZ",
)
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="mysql://root:admin@localhost:3306/template",
    ),
}
...
STATICFILES_DIRS = [str(APPS_DIR / "templates/static")]
...
ADMINS = [("""Jason Stabins""", "jay@jaystabins.com")]
